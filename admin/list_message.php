...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center">List Message</h1>
            </div>
       </div>
        <!-- /.row -->	
 ...
 <div class="row">
 <div class="col-md-12">
            <form action="proses_pencarian_message.php" method="post" >
...
$query=mysql_query("SELECT * FROM tbl_komentar order by id_komentar desc limit $posisi,$batas");
...
<td><p data-placement="top" data-toggle="tooltip" title="Delete"><a href="javascript:if(confirm('Anda Yakin Akan Menghapus Pesan Dari <? echo $nama_lengkap ?> Ini ?')){document.location='delete_message.php?id_komentar=<?php echo $id_komentar; ?>';}">
...
<?}?>
 ...
 <?
$query2=mysql_query("select * from tbl_komentar");
...
if (1 != $paging){//tanda != berarti perintah akan dijalankan jika $paging tidak sama dengan 1, copyright all teknik paging by go_blind_hacker, powered by V-boys_studio
	$back=$paging-1;
	echo "<li><a href='list_message.php?paging=$back'><span class='glyphicon glyphicon-chevron-left'></span></a></li>";
	}
	else{
...
if ($paging != $jumlah_halaman){    
	$next=$paging+1;
	echo "<li><a href='list_message.php?paging=$next'><span class='glyphicon glyphicon-chevron-right'></span></a></li>";
	}
	else
	{
