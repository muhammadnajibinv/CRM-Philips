...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center">List Pemesanan Product Baru</h1>
            </div>
		</div>
        <!-- /.row -->	
...
$sql="SELECT * FROM tbl_orders WHERE status_order='Baru' ORDER BY id_orders DESC limit $posisi,$batas";
...
<td><p data-placement="top" data-toggle="tooltip" title="Delete"><a href="javascript:if(confirm('Anda Yakin Akan Menghapus Pemesanan Dari <? echo $nama_pemesan ?> Ini ?')){document.location='delete_pemesanan_product_baru.php?id_orders=<?php echo $id_orders; ?>';}">
...
<?}?>
 ...
 <?
$query2=mysql_query("select * from tbl_orders WHERE status_order='Baru'");
...
if (1 != $paging){//tanda != berarti perintah akan dijalankan jika $paging tidak sama dengan 1, copyright all teknik paging by go_blind_hacker, powered by V-boys_studio
	$back=$paging-1;
	echo "<li><a href='list_pemesanan_product_baru.php?paging=$back'><span class='glyphicon glyphicon-chevron-left'></span></a></li>";
	}
	else{
...
if ($paging != $jumlah_halaman){    
	$next=$paging+1;
	echo "<li><a href='list_pemesanan_product_baru.php?paging=$next'><span class='glyphicon glyphicon-chevron-right'></span></a></li>";
	}
	else
	{
