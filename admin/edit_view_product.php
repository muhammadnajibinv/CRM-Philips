...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center">Edit View Product</h1>
            </div>
		</div>
...
?>			
        ...
        <!-- /.row -->	
	<!--  panel preview -->
		<form method="post" action="proses_edit_view_product.php?id_view=<? echo $_GET[id_view];?>" enctype="multipart/form-data">
			<div class="row">
                    <div class="col-md-12">
						<div class="form-group">
						<label>Nama View Product</label>
						<select class="form-control" name='nama_view' id='nama_view' required autofocus>
						<?$query=mysql_query("SELECT * FROM tbl_product_view WHERE id_view='".$_GET['id_view']."'");
						while($hasil=mysql_fetch_array($query))
						{ 
						echo '<option>'.$hasil['nama_view'].'</option>';
						}
						?>
						<?php
						...
						<div class="form-group">
						<textarea class="form-control counted" rows="5" name="keterangan" id="keterangan" required><?echo"$keterangan";?></textarea>
