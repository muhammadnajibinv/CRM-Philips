...
if ($_POST['submit']) {
	$query=mysql_query("select * from tbl_komentar where id_customer like '%$query%' OR nama_lengkap like '%$query%' OR username like '%$query%' OR email like '%$query%' OR pesan like '%$query%' OR status like '%$query%' OR hak_akses like '%$query%' order by id_customer ");
...
echo"<div class='pagination pull-right'>";
	...
	echo "<li><a href='list_message.php'><span class='glyphicon glyphicon-chevron-left'></span></a></li>";
