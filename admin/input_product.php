...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center">Input Product</h1>
            </div>
		</div>
        ...
        <!-- /.row -->	
	<!--  panel preview -->
		<form method="post" action="proses_simpan_product.php">
			<div class="row">
                    <div class="col-md-12">
                  		<div class="form-group">
						<label>Nama Product</label>
                            <input type="text" class="form-control" id="nama_product" name="nama_product" maxlength="50" required autofocus>
                  		</div>
						<div class="form-group">
						...
						<div class="form-group">
						<label>Barcode</label>
                            <input type="text" class="form-control" id="barcode" name="barcode" onkeypress="return hanyaAngka(event, false)"onkeypress="return hanyaAngka(event, false)" maxlength="20" required>
                  		</div>
						<div class="form-group">
						<label>Harga Product</label>
                            <input type="text" class="form-control" id="harga" name="harga" onkeypress="return hanyaAngka(event, false)"onkeypress="return hanyaAngka(event, false)" maxlength="10" required>
                  		</div>
						<div class="form-group">
						<label>Stok</label>
                            <input type="text" class="form-control" id="stok" name="stok" onkeypress="return hanyaAngka(event, false)"onkeypress="return hanyaAngka(event, false)" maxlength="5" required>
                  		</div>
