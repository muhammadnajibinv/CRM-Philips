            ...
            <div class="panel panel-default">
                <div class="panel-body form-horizontal payment-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" maxlength="50" required>
                        </div>
                    </div>
					<div class="form-group">
...
if ($_POST['submit']) {
	$query=mysql_query("select * from tbl_kategori where id_kategori like '%$query%' OR nama_mag like '%$query%' OR nama_kategori like '%$query%' order by id_kategori ");
...
echo"<div class='pagination pull-right'>";
	...
	echo "<li><a href='kategori.php'><span class='glyphicon glyphicon-chevron-left'></span></a></li>";
