...
if ($_POST['submit']) {
	$query=mysql_query("select * from tbl_product_customer where nama_mag like '%$query%' OR nama_kategori like '%$query%' OR nama_product like '%$query%' OR harga like '%$query%' order by id_product");
...
<td> <? echo"Rp.$harga"; ?> </td>
<td><?if($hasil[stok]=="0"){echo "<p data-placement='top' data-toggle='tooltip' title='Stok Habis'><a class='btn btn-danger btn-xs' href='proses_cart.php?module=cart&act=tambah&id=<? echo $id_product;?>'><span class='glyphicon glyphicon-alert'></span></button></p>"; 
	  }else{
	  echo "<p data-placement='top' data-toggle='tooltip' title='Add To Cart'><a class='btn btn-primary btn-xs' href='proses_cart.php?module=cart&act=tambah&id=<? echo $id_product;?>'><span class='glyphicon glyphicon-shopping-cart'></span></button></p>";
	}?>
</td>
</tr>	
</tbody>
...
echo"<div class='pagination pull-right'>";
	...
	echo "<li><a href='list_pesan_product.php'><span class='glyphicon glyphicon-chevron-left'></span></a></li>";
